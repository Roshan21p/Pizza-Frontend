...
export const getAllProducts = createAsyncThunk('/products/getAll', async (__, {rejectWithValue}) => {
  try {
...
export const addNewProduct = createAsyncThunk('/products/createProduct', async (data ,{rejectWithValue}) => {
  try {
...
export const updateProduct = createAsyncThunk('/product/updateProduct', async ({productId, formData}, {rejectWithValue}) => {
  try {
