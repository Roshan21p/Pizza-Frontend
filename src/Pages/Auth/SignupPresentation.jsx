        ...
        <Layout>
            <section className="text-gray-600 body-font ">
                <div className="flex flex-wrap items-center bg-gradient-to-r from-amber-50 to-orange-300 px-10 py-6 mx-auto">
                    ...
                    <form className="flex flex-col w-full p-8 mt-0 bg-gray-100 rounded-lg lg:w-1/3 md:w-1/2 md:ml-auto md:mt-0 "
                     noValidate>

                        <h2 className="mb-5 text-lg font-medium text-gray-900 title-font">Sign up</h2>

                        <div className="relative mb-4">
                            <label htmlFor="firstName" className="text-sm leading-7 text-gray-600"> FirstName </label>
                        ...
                        <Link to="/auth/login" className="text-yellow-500">Login</Link></p>
                    </form>
