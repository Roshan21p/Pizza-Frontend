...
function Home() {
  ...
  return (
    <Layout>
      <div>
        {/* Hero Section */}
        <section className="flex flex-col-reverse items-center justify-center py-5 w-full md:flex-row md:gap-7 bg-gradient-to-r from-amber-50 to-orange-300">
          <div className="w-4/6 ml-4 text-center md:w-2/6 md:text-left">
            ...
            <p className="pb-4 text-[#687280] ">
              The Pizza App lets you order favorite pizza from the comfort of your home. Enjoy the
              best pizza in town with just a few click.
            </p>
                ...
                <div className="flex flex-wrap space-y-6 md:space-y-0">
                  ...
                  <div className="flex flex-col items-center text-center p-4 md:w-1/3">
                    ...
                    <div className="flex-grow">
                      ...
                      <p className="text-base leading-relaxed">
                        Pickup up yuor order from the nearest store or get it delivered to your
                        doorstep.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex flex-col items-center text-center p-4 md:w-1/3">
                    ...
                    <div className="flex-grow">
                      ...
                      <p className="text-base leading-relaxed">
                        As soon as you get you order, enjoy the delicious pizza with your loved
                        ones.
                      </p>
                    </div>
                  </div>
